    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionSkills", x => new { x.PositionId, x.RequiredSkillsId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_PositionSkills_Skills_RequiredSkillsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateSkills", x => new { x.CandidateId, x.SkillsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InterviewStages_Applications_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InterviewStageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedback_InterviewStages_InterviewStageId",
                        column: x => x.InterviewStageId,
                        principalTable: "InterviewStages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedback_InterviewStageId",
                table: "Feedback",
                column: "InterviewStageId");

            migrationBuilder.CreateIndex(
                name: "IX_InterviewStages_ApplicationId",
                table: "InterviewStages",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionSkills_RequiredSkillsId",
